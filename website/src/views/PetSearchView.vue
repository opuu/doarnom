    ...
    <div class="search-container">
      <aside class="filters">
        ...
        <div class="filter-group">
          <label>Search</label>
          <InputText v-model="filters.search" placeholder="Name or keyword" />
        </div>
        <div class="filter-group">
          <label>Species</label>
          <Dropdown
        ...
        <div class="filter-group">
          <label>Age (yrs)</label>
          <Slider v-model="filters.ageRange" :min="0" :max="15" :range="true" />
        ...
        <div class="filter-group checkbox-group">
          <Checkbox v-model="filters.fixed" :binary="true" inputId="fixed" />
      ...
      <div class="results">
        ...
        <div class="grid">
          <div v-for="p in filteredPets" :key="p.id" class="pet-card">
            <div class="img-wrap">
              <img
                :src="p.image ? p.image : 'https://placehold.co/600x400'"
                :alt="p.name"
              />
            </div>
            <div class="info">
